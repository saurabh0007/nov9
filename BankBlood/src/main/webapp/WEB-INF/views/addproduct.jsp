        ...
        <div class="col-md-12 col-sm-6">
                ...
                <h2 class="title"><b>Add Product</b></h2>
                    ...
                    <form:form method="POST" action="AddProductToDB" modelAttribute="Product" enctype="multipart/form-data">
                    	...
                    	<form:label path="productName">Enter Blood Name:</form:label>
                    	<form:input type="text" path="productName" class="form-control"/>
                    
                    	<br>
                    	
                    	
                    	<form:label path="productCategory">Enter Blood Category:</form:label>
                    	...
                    	<form:label path="productDescription">Enter Hospital Name:</form:label>
                    	<form:input type="text" path="productDescription" class="form-control"/>
                    	
                    	<br>
                    	
                    	<form:label path="productPrice">Enter Blood Unit:</form:label>
                    	<form:input type="number" path="productPrice" class="form-control"/>
                    	
                    	<br>
                    	
                    	<form:label path="productImage">Enter Image:</form:label> 
                    	...
                    	<input type="submit" class="btn btn-success" value="Add Blood"/>
                    	<br>
                    	<br>
                    	<br>
                    	<br>
