...
<div align="center">
			...
			<br>
					...
					<div class="col-sm-2" >
						<a href="${pageContext.request.contextPath}/viewproduct/{{x.ProductId}}" class="btn btn-info">View Blood</a>
					</div>
					<%
						if (request.isUserInRole("ADMIN"))
						{
					...
					<div class="col-sm-2" >
						<a href="${pageContext.request.contextPath}/updateproduct/{{x.ProductId}}" class="btn btn-warning">Update Blood</a>
					</div>
					
					<div class="col-sm-2" >
						<a href="${pageContext.request.contextPath}/DeleteProductFromDB/{{x.ProductId}}" class="btn btn-danger">Delete Blood</a>
					</div>
					<%							
						}
						%>
