...
<br>
	...
	<div class="container view-container" style="background-color: rgba(255,255,255,0.8);">
		<div class="row row-bottom">
			...
			<div class="col-lg-6">
				<label path="productName" class="corbert-class" >Blood Name:</label>
			</div>
		...
		<div class="row row-bottom">
			...
			<div class="col-lg-6">
				<label path="productCategory" class="corbert-class">Blood Category:</label>
			</div>
		...
		<div class="row row-bottom">
			...
			<div class="col-lg-6">
				<label path="productDescription" class="corbert-class">Hospital Name:</label>
			</div>
		...
		<div class="row row-bottom">
			...
			<div class="col-lg-6">
				<label path="productPrice" class="corbert-class">Blood Unit:</label>
			</div>
		...
		<div class="row row-bottom">
			...
			<div class="col-lg-6">
				<label path="productImage" class="corbert-class">Person Image:</label>
			</div>
